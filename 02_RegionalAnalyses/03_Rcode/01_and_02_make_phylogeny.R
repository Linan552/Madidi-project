...
trees.merged <- read.csv("./02_Data/MergedCleanData/ToyData_trees.txt", 
...
#make results directory if its not already there.
subDir <- "/04_Results"
ifelse(!dir.exists(file.path(project.directory, subDir)), dir.create(file.path(project.directory, subDir)), FALSE)
#write output
